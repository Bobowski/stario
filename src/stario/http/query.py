...
indexes C name/value spans on the original bytes when names need no in-place
unquote; ``get`` / ``getlist`` search those and decode only the values you
ask for. No Python implementation — this module is for IDEs and typecheckers.
"""
